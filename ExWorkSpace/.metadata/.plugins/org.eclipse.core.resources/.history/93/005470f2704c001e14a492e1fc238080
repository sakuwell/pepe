...
<body>
    ...
    <!-- ヒーロー画像 -->
    <img class="img-fluid mb-4" src="images/hero_top.jpg"  alt="top画像" style="max-height:600px; width:100%; object-fit: cover;">
        ...
        <div class="container">
            ...
            <div class="row">
               ...
               <div class="col-6 col-md-4 col-lg-3">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card mb-3">
                        <img src="images/cat_2.jpg" class="card-img-top" alt="猫画像" style="width:100%">
                        <div class="card-body">
	...
	<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    	<div class="col-md-4 d-flex align-items-center ms-3">
        	<a href="top.jsp" class="mb-3 me-2 mb-md-0"><img alt="ロゴ画像" src="images/nikukyu_logo.png" width="auto" height="40"></a>
